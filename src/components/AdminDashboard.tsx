...
interface AnalyticsData {
  ...
  links: { id: string; name: string; catalogId: string; filename: string; opens: number; lastOpenedAt: string | null }[];
...
const linkUrl = (id: string) => `${window.location.origin}/share/${encodeURIComponent(id)}`;
